sap.ui.define([
    ...
    "sap/m/TileContent",
    "sap/m/ImageContent"
], function (Controller, MessageBox, Dialog, Button, Input, TileContent, ImageContent) {
    "use strict";
    return Controller.extend("treinamento.ui5.controller.App", {

        onInit: function () {
            MessageBox.information("Clique em uma vaga e insira uma placa de carro para estacionar", {
                title: "Bem Vindo",
            });
        },
